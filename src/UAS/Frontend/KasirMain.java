...
public class KasirMain extends javax.swing.JFrame {
     ...
     */
    public KasirMain(int idUser, String jabatanUser) {
        initComponents();
        setLocationRelativeTo(null);

        idUserHidden.setText(String.valueOf(idUser));
        this.jabatanUser.setText(jabatanUser);
        idUserHidden.setVisible(false);
        this.jabatanUser.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        jabatanUser = new javax.swing.JMenu();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UAS/img/BankSampah.png"))); // NOI18N
        ...
        jabatanUser.setText("roleUser");
        jMenuBar1.add(jabatanUser);
    ...
    private void menuTransaksiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menuTransaksiMouseClicked
        // TODO add your handling code here:
        new FormTabelTransaksi(Integer.parseInt(idUserHidden.getText()), jabatanUser.getText()).setVisible(true);
    ...
    private javax.swing.JMenu jabatanUser;
